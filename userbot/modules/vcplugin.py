...
@sansanzt_cmd(pattern="play(?:\\s|$)([\\s\\S]*)")
...
@sansanzt_cmd(pattern="vplay(?:\\s|$)([\\s\\S]*)")
...
@sansanzt_cmd(pattern="skip(?:\\s|$)([\\s\\S]*)")
